...
3. **For each untriaged item**, analyze the content and execute:
   ...
   b. **Create or append**:
      - If the content is a new thread: create a Note in `Notes/` with proper frontmatter (type, efforts, status, dates, effort_level, timescale, context_group, tags). Filename: `Notes/[descriptive-slug].md`
